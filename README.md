...
1.  **Übersichts-Dashboard (`solar-scada-overview.json`, UID `solar-scada-overview`)**: Visualisiert die wichtigsten KPIs des aktuellen Tages (PV, Netz, Haus, Akku-Netto), den Leistungsfluss-Verlauf, Autarkie/Eigenverbrauch, die Netz-Bilanz (Bezug vs. Einspeisung) und den Ladezustand der Batterie.
