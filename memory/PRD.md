...
- [ ] Security Audit: Risiken offen — unauthentifizierte Steuerungsrouten, offengelegte MQTT-Zugangsdaten und permissives CORS mit Credentials benötigen technische Schutzmaßnahmen; LAN-Betrieb allein gilt nicht als ausreichende Mitigation.
